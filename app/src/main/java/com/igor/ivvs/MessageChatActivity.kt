...
import com.igor.ivvs.adapterClasses.ChatAdapter
import com.igor.ivvs.modelClasses.Chat
...
class MessageChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recycler_view_chat = findViewById(R.id.recycler_view_chats)
        ...
        attack_image_file_btn.setOnClickListener {
            val intent = Intent()
